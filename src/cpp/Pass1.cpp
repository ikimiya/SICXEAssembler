        ...
        while(OpCode != "END")
        {
            ...
            if(Label[0] != '.')
            {
                ...
                else if(OpCode == "MACRO")
                {
                    ...
                    // set Start and End Values of the macroName
